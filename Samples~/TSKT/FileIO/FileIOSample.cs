...
namespace TSKT
{
    public class FileIOSample : MonoBehaviour
    {
        ...
        public async void LoadStringAsync()
        {
            ...
            Debug.Log(text.hasValue ? text.value : "empty");
        }
        ...
        public async void LoadBytesAsync()
        {
            ...
            Debug.Log("load foo.txt");
            Debug.Log(bytes.hasValue ? System.Text.Encoding.UTF8.GetString(bytes.value) : "empty");
        }
        ...
        public void Load()
        {
            ...
            Debug.Log(udon.hasValue ? udon.value.name : "empty");
        }
